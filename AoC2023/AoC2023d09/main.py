...
def reverse_extrapolate(row):
    ...
    for i in range(tri_length):
        ...
        if row_index == -1:
            ...
            next_row_first = triangle[row_index+1][0]
            this_row_first = triangle[row_index][0]
            triangle[row_index].insert(0,this_row_first-next_row_first)
...
for r in readings:
    ...
    new_beginnings.append(reverse_extrapolate(r))
...
print(f"Part 2 answer: {sum(new_beginnings)}")