...
@lru_cache(maxsize=None)
def max_relief_from_state(current_valve,current_time,closed_valves):
    max_relief = 0
    ...
    for v in closed_valves:
        ...
        new_max = max_relief_from_state(v.name, new_time,new_closed_tuple)
...
print("before mrfs")
part_1_answer = max_relief_from_state(current_valve,current_time,tuple(closed_pf_valves))
